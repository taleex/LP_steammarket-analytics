              ...
              <ScrollArea className="h-40 md:h-48 border rounded-lg bg-gradient-subtle">
                <div className="p-2 md:p-4 space-y-2 md:space-y-3">
                  {newTransactions.map((transaction, index) => (
                    <div
                      key={index}
                      className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-3 p-2 md:p-3 rounded-md bg-card border border-border/50 hover:border-border transition-colors"
                    >
                      <div className="flex items-center gap-2 md:gap-3 min-w-0">
                        <CheckCircle className="h-3 w-3 md:h-4 md:w-4 text-profit flex-shrink-0" />
                        <div className="flex flex-col gap-1 min-w-0">
                          <span className="font-medium text-card-foreground text-sm md:text-base truncate">
                            {transaction.item}
                          </span>
                      ...
                      <div className="flex items-center gap-2 md:gap-3 flex-shrink-0">
                        ...
                        <span
                          className={`font-mono font-semibold text-sm md:text-base ${
